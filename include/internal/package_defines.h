...
#define PACKAGE_UNUSED_LEN 0x9C
...
#define PACKAGE_RES_CNT_OFF     0x51
#define PACKAGE_BODY_OFF_OFF    0x54
#define PACKAGE_BODY_LEN_OFF    0x5C
#define PACKAGE_UNUSED_OFF      0x64
